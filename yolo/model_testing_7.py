...
def Find_SPI_Value(Input_image, ML_model, Threshhold):
    
    INPUT_IMAGE_URL = Input_image
    DETECTION_THRESHOLD = Threshhold
    TFLITE_MODEL_PATH = ML_model
...
Find_SPI_Value(image_name, TFLITE_MODEL_PATH, 0.2)
